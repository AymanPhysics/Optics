...
Public Class ServicesIsLabToLab
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        DataGridView1.Columns(dt.Columns("ServiceGroupId").Ordinal).Visibility = Windows.Visibility.Hidden
        DataGridView1.Columns(dt.Columns("ServiceGroupName").Ordinal).Visibility = Windows.Visibility.Hidden
        DataGridView1.Columns(dt.Columns("ServiceTypeId").Ordinal).Visibility = Windows.Visibility.Hidden
