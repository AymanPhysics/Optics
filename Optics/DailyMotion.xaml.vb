...
Public Class DailyMotion
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CustomerId.KeyDown, NolonPricesId.KeyDown, SuppPersonId.KeyDown
