...
Public Class ProductionItemCollectionMotion
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {"Flag", MainId, SubId, "DayDate", "Notes", "DocNo", "MotionTypeId", "Temp", "ItemId", "Qty", "EmpId1", "EmpId2", "EmpId3", "EmpId4", "EntryUser", "EntryDate", "SystemUser", "UpdateDate", "NewInvoiceNo", "OreStoreId"}
        bm.control = New Control() {txtFlag, StoreId, InvoiceNo, DayDate, Notes, DocNo, MotionTypeId, Temp, ItemId, Qty, EmpId1, EmpId2, EmpId3, EmpId4, EntryUser, EntryDate, SystemUser, UpdateDate, NewInvoiceNo, OreStoreId}
...
Br:
    ...
    Private Sub OreStoreId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles OreStoreId.KeyUp
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles StoreId.KeyDown, InvoiceNo.KeyDown, txtID.KeyDown, EmpId1.KeyDown, EmpId2.KeyDown, EmpId3.KeyDown, EmpId4.KeyDown
    ...
    Private Sub PrintPone(ByVal sender As System.Object, ByVal NewItemsOnly As Integer)
        ...
        rpt.paraname = New String() {"@FromDate", "@ToDate", "@MainFlag", "@Flag", "@StoreId", "@FromInvoiceNo", "@ToInvoiceNo", "Header", "@ItemId", "@TypeId", "@GroupId", "Manager"}
        rpt.paravalue = New String() {DayDate.SelectedDate, DayDate.SelectedDate, 0, Flag, StoreId.Text, InvoiceNo.Text, InvoiceNo.Text, CType(Parent, Page).Title, ItemId.Text, 0, 0, IIf(Md.Manager, 1, 0)}
