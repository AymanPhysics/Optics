...
Public Class HelpCases
    ...
    Private Sub Help_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Loaded
        ...
        If Not AllowAdd Then btnSave.Visibility = Windows.Visibility.Hidden
        Try
    ...
    Private Sub btnSave_Click(sender As Object, e As RoutedEventArgs) Handles btnSave.Click
        ...
        If txtTel.Text.Trim.Length < 7 AndAlso txtMob.Text.Trim.Length < 7 Then
            bm.ShowMSG("برجاء تحديد التليفون")
            Return
        End If
        ...
        If Not bm.AddItemToTable(tbl, {"Name", "EnName", "NationalId", "HomePhone", IIf(Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X2, "Age", "Mobile"), "Address", "AccNo"}, {txtArName.Text, txtEnName.Text, NationalId.Text, txtTel.Text, txtMob.Text, txtAddress.Text, StrAccNo}) Then Return
