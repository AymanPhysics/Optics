...
Public Class Installment
    ...
    Private Sub Installment_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        If Flag = 35 Then
            CustTbl = "Investors"
            Panel1.Visibility = Windows.Visibility.Hidden
        End If
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles ToId.KeyDown, StoreId.KeyDown, SaveId.KeyDown
