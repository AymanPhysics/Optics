...
Public Class Tasks
    ...
    Private Sub LoadAll() 
        ...
        Try
            ...
            DataGridView2.Columns(dt2.Columns("PreventDone").Ordinal).Visibility = Windows.Visibility.Hidden
    ...
    Private Sub Calendar1_SelectedDatesChanged(sender As Object, e As SelectionChangedEventArgs) Handles Calendar1.SelectedDatesChanged
        ...
        Try
            ...
            DataGridView1.Columns(dt.Columns("DidEmpId").Ordinal).Visibility = Windows.Visibility.Hidden
            DataGridView1.Columns(dt.Columns("PreventDone").Ordinal).Visibility = Windows.Visibility.Hidden
