...
Public Class Customers
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Else
            Ban2.Visibility = Windows.Visibility.Hidden
            BanNotes.Visibility = Windows.Visibility.Hidden
            lblBanNotes.Visibility = Windows.Visibility.Hidden
        End If

        If Not Md.MyProjectType = ProjectType.X29 Then
            btnMonthlyPayment.Visibility = Windows.Visibility.Hidden
            lblMonthlyPayment.Visibility = Windows.Visibility.Hidden
            MonthlyPayment.Visibility = Windows.Visibility.Hidden
            lblMonthlyPaymentDay.Visibility = Windows.Visibility.Hidden
            MonthlyPaymentDay.Visibility = Windows.Visibility.Hidden
        End If
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CountryId.KeyDown, CityId.KeyDown, AreaId.KeyDown, AccNo.KeyDown, EmpId.KeyDown, AccNo.KeyDown
