...
Public Class OrderStatus
    ...
    Private Sub BasicForm2_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Select Case Flag
            Case 1
                '''''''''''''
            Case 1
                lblEmpId2.Visibility = Windows.Visibility.Hidden
                EmpId2.Visibility = Windows.Visibility.Hidden
                EmpName2.Visibility = Windows.Visibility.Hidden

                lblEmpId3.Visibility = Windows.Visibility.Hidden
                EmpId3.Visibility = Windows.Visibility.Hidden
                EmpName3.Visibility = Windows.Visibility.Hidden

                lblEmpId4.Visibility = Windows.Visibility.Hidden
                EmpId4.Visibility = Windows.Visibility.Hidden
                EmpName4.Visibility = Windows.Visibility.Hidden
            Case 2
                lblEmpId1.Visibility = Windows.Visibility.Hidden
                EmpId1.Visibility = Windows.Visibility.Hidden
                EmpName1.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub DataGridView1_PreviewMouseDoubleClick(sender As Object, e As MouseButtonEventArgs) Handles DataGridView1.PreviewMouseDoubleClick
        ...
        If EmpId1.Visibility = Windows.Visibility.Visible AndAlso Val(EmpId1.Text) = 0 Then
            bm.ShowMSG("برجاء تحديد موظف ال" & lblEmpId1.Content)
            EmpId1.Focus()
            Return
        End If
        If EmpId2.Visibility = Windows.Visibility.Visible AndAlso Val(EmpId2.Text) = 0 Then
            bm.ShowMSG("برجاء تحديد موظف ال" & lblEmpId2.Content)
            EmpId2.Focus()
            Return
        End If
        If EmpId3.Visibility = Windows.Visibility.Visible AndAlso Val(EmpId3.Text) = 0 Then
            bm.ShowMSG("برجاء تحديد موظف ال" & lblEmpId3.Content)
            EmpId3.Focus()
            Return
        End If
        If EmpId4.Visibility = Windows.Visibility.Visible AndAlso Val(EmpId4.Text) = 0 Then
        ...
        If bm.ShowDeleteMSG(MyMsg) Then
            Dim str As String = bm.ExecuteScalar("exec GenerateProductionOrder " & DataGridView1.CurrentItem("Flag") & ",'" & DataGridView1.CurrentItem("StoreId") & "'," & DataGridView1.CurrentItem("المسلسل") & "," & DataGridView1.CurrentItem("الكمية") & "," & Val(EmpId1.Text) & "," & Val(EmpId2.Text) & "," & Val(EmpId3.Text) & "," & Val(EmpId4.Text))
            'If Flag = 4 Then
            If Flag = 1 Then
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles EmpId1.KeyDown, EmpId2.KeyDown, EmpId3.KeyDown, EmpId4.KeyDown
    ...
    Private Sub EmpId4_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles EmpId4.KeyUp
