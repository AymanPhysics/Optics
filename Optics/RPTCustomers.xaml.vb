...
Public Class RPTCustomers
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles CityId.KeyDown, CountryId.KeyDown, DegreeId.KeyDown, SpecialtyId.KeyDown, SponsorId.KeyDown, SubSpecialtyId.KeyDown, TitleId.KeyDown, UniversityId.KeyDown
