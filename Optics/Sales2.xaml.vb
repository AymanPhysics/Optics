...
Public Class Sales2
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        LoadResource()
        If Not Md.MyProjectType = ProjectType.X27 Then
            btnPrintA6.Visibility = Windows.Visibility.Hidden
        End If
        ...
        If Not (Flag = FlagState.المبيعات OrElse Flag = FlagState.مردودات_المبيعات OrElse Flag = FlagState.مشتريات_من_عملاء OrElse Flag = FlagState.مبيعات_الوردية) Then
            DriverName.Visibility = Windows.Visibility.Hidden
            CarNo.Visibility = Windows.Visibility.Hidden
            btnPrintCar.Visibility = Windows.Visibility.Hidden
            Distance.Visibility = Windows.Visibility.Hidden
            lblDriverName.Visibility = Windows.Visibility.Hidden
            lblCarNo.Visibility = Windows.Visibility.Hidden
            lblDistance.Visibility = Windows.Visibility.Hidden
        ...
        If False Then 'Md.ShopItemsOnly
            ...
            btnCalcAddDed.Visibility = Windows.Visibility.Hidden
            GNumbers.Visibility = Windows.Visibility.Visible
            btnDeleteRow.Visibility = Windows.Visibility.Hidden
            btnNewWindow.Visibility = Windows.Visibility.Hidden
        ...
        If Not (Flag = FlagState.المبيعات OrElse Flag = FlagState.مبيعات_الوردية) Then
            Tips.Visibility = Windows.Visibility.Hidden
            lblTips.Visibility = Windows.Visibility.Hidden
        ...
        If Not Md.Manager Then
            ...
            btnCustomers.Visibility = Windows.Visibility.Hidden
            btnItems.Visibility = Windows.Visibility.Hidden
            ...
            If Md.MyProjectType = ProjectType.X27 OrElse Not Md.Manager Then
                btnProfit.Visibility = Windows.Visibility.Hidden
            End If
        End If
