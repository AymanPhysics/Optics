...
Public Class Statics
    ...
    Private Sub Statics_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        lblPoneComment.Visibility = Windows.Visibility.Hidden
        PoneComment.Visibility = Windows.Visibility.Hidden
        lblPoneHeader.Visibility = Windows.Visibility.Hidden
        PoneHeader.Visibility = Windows.Visibility.Hidden
        'End If

        Dim dt As DataTable = bm.ExecuteAdapter("select PoneComment,PoneHeader,CompanyName,CompanyTel,WhatsAppLink,gmail,gmailPassword from Statics")
    ...
    Private Sub btnSave_Click(sender As Object, e As RoutedEventArgs) Handles btnSave.Click
        ...
        If Md.Manager Then
            bm.ExecuteNonQuery("update Statics set PoneComment='" & PoneComment.Text.Replace("'", "''") & "',PoneHeader='" & PoneHeader.Text.Replace("'", "''") & "',CompanyName='" & CompanyName.Text.Replace("'", "''") & "',CompanyTel='" & CompanyTel.Text.Replace("'", "''") & "',WhatsAppLink='" & WhatsAppLink.Text.Replace("'", "''") & "',gmail='" & gmail.Text.Replace("'", "''") & "',gmailPassword='" & gmailPassword.Text.Replace("'", "''") & "'")
        End If
