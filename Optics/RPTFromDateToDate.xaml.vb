...
Public Class RPTFromDateToDate
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@StoreId", "StoreName", "@FromDate", "@ToDate", "Header"}
        rpt.paravalue = New String() {Val(StoreId.Text), StoreName.Text, FromDate.SelectedDate, ToDate.SelectedDate, CType(Parent, Page).Title}
        Select Case Flag
            Case 1
            ...
            Case 9
                rpt.Rpt = "ImportMessages21.rpt"
            Case 10
                rpt.Rpt = "RotationRate.rpt"
            Case 11
                rpt.Rpt = "ItemstSalesFastest.rpt"
            Case 12
                rpt.Rpt = "CustomersMostIncome.rpt"
        End Select
        rpt.Show()
    End Sub
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Flag = 10 OrElse Flag = 11 Then
