...
Public Class NolonPriceTypes
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CountryId.KeyDown, CityId.KeyDown, AreaId.KeyDown, CountryId1.KeyDown, CityId1.KeyDown, AreaId1.KeyDown
        bm.MyKeyPress(sender, e)
    End Sub

    Private Sub txtID2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Price1.KeyDown, Price2.KeyDown, Price3.KeyDown, Price4.KeyDown, Price5.KeyDown
