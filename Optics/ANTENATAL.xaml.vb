...
Public Class ANTENATAL
    ...
    Private Sub InFertility_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
        ...
        btnComplaint.Visibility = Windows.Visibility.Hidden
        'btnDrugsAndDoses.Visibility = Windows.Visibility.Hidden
        btnPrint.Visibility = Windows.Visibility.Hidden
        GDrugs.Visibility = Windows.Visibility.Hidden
        btnSave_Copy.Visibility = Windows.Visibility.Hidden
