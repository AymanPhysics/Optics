...
Public Class OperationMotions
    ...
    Public Sub OperationMotions_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.TestSecurity(Me, {btnSaveWithoutPrint}, {btnDelete}, {btnFirst, btnNext, btnPrevios, btnLast}, {btnSave})
        LoadResource()
        ...
        Done.Visibility = Windows.Visibility.Hidden
        ...
        lblSerialId.Visibility = Windows.Visibility.Hidden
        SerialId.Visibility = Windows.Visibility.Hidden
        lblRemaining.Visibility = Windows.Visibility.Hidden
        Remaining.Visibility = Windows.Visibility.Hidden

        lblNoOfDays.Visibility = Windows.Visibility.Hidden
        NoOfDays.Visibility = Windows.Visibility.Hidden

        If Not Md.MyProjectType = ProjectType.X2 Then
            '    btnPackage.Visibility = Windows.Visibility.Hidden
            '    lblRoomValue2.Visibility = Windows.Visibility.Hidden
            '    RoomValue2.Visibility = Windows.Visibility.Hidden
            '    lblCsValue.Visibility = Windows.Visibility.Hidden
            '    CsValue.Visibility = Windows.Visibility.Hidden
            '    lblMedicalValue.Visibility = Windows.Visibility.Hidden
            '    MedicalValue.Visibility = Windows.Visibility.Hidden
            '    lblCoValue.Visibility = Windows.Visibility.Hidden
            '    CoValue.Visibility = Windows.Visibility.Hidden
        ...
        If Md.MyProjectType = ProjectType.X8 AndAlso Md.Receptionist Then
            Dr1Value.Visibility = Windows.Visibility.Hidden
            Dr2Value.Visibility = Windows.Visibility.Hidden
            Dr3Value.Visibility = Windows.Visibility.Hidden
            AnesthetistValue.Visibility = Windows.Visibility.Hidden
            lblRoomValue.Visibility = Windows.Visibility.Hidden
            RoomValue.Visibility = Windows.Visibility.Hidden
            lblConsumablesValue.Visibility = Windows.Visibility.Hidden
            ConsumablesValue.Visibility = Windows.Visibility.Hidden
        End If
        If Md.MyProjectType = ProjectType.X8 Then
            lblRefereId.Visibility = Windows.Visibility.Hidden
            RefereId.Visibility = Windows.Visibility.Hidden
            RefereName.Visibility = Windows.Visibility.Hidden
        End If
    End Sub
    ...
    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Value.KeyDown, Remaining.KeyDown, RoomValue.KeyDown, RoomValue2.KeyDown, Dr1Value.KeyDown, Dr2Value.KeyDown, Dr3Value.KeyDown, AnesthetistValue.KeyDown, CsValue.KeyDown, MedicalValue.KeyDown, CoValue.KeyDown, ConsumablesValue.KeyDown, Value.KeyDown, Payed.KeyDown
    ...
    Private Sub Canceled_Checked(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Canceled.Checked
        ...
        CanceledDate.Visibility = Windows.Visibility.Visible
        CanceledDate.IsEnabled = Md.Manager
        EmpIdCanceled.Visibility = Windows.Visibility.Visible
    ...
    Private Sub Returned_Checked(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Returned.Checked
        ...
        ReturnedDate.Visibility = Windows.Visibility.Visible
        ReturnedDate.IsEnabled = Md.Manager
        EmpIdReturned.Visibility = Windows.Visibility.Visible
    ...
    Private Sub Canceled_Unchecked(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Canceled.Unchecked
        ...
        CanceledDate.Visibility = Windows.Visibility.Hidden
        CanceledDate.SelectedDate = Nothing
        EmpIdCanceled.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub Returned_Unchecked(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Returned.Unchecked
        ...
        ReturnedDate.Visibility = Windows.Visibility.Hidden
        ReturnedDate.SelectedDate = Nothing
        EmpIdReturned.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub RefereId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles RefereId.KeyUp
    ...
    Private Sub Done_Checked(sender As Object, e As RoutedEventArgs) Handles Done.Checked
        ...
        lblSerialId2.Visibility = Windows.Visibility.Visible
        SerialId2.Visibility = Windows.Visibility.Visible

        RemainingDate.Visibility = Windows.Visibility.Visible
        RemainingDate.SelectedDate = bm.MyGetDate()
        RemainingDate.IsEnabled = Md.Manager
        EmpIdRemaining.Visibility = Windows.Visibility.Visible
    ...
    Private Sub Done_Unchecked(sender As Object, e As RoutedEventArgs) Handles Done.Unchecked
        ...
        lblSerialId2.Visibility = Windows.Visibility.Hidden
        SerialId2.Visibility = Windows.Visibility.Hidden

        RemainingDate.Visibility = Windows.Visibility.Hidden
        RemainingDate.SelectedDate = Nothing
        EmpIdRemaining.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub RoomId_LostFocus(sender As Object, e As RoutedEventArgs) Handles RoomId.LostFocus, DrId1.LostFocus
        ...
        For i As Integer = 0 To G.Rows.Count - 1
            ...
            If Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X8 Then
    ...
    Private Sub btnPackage_Click(sender As Object, e As RoutedEventArgs) Handles btnPackage.Click
        If bm.ShowDeleteMSG("هل تريد تحويل الحالة إلي حالة خاصة") Then
            ...
            MedicalValue.Clear()
            CoValue.Clear()
            If Md.MyProjectType = ProjectType.X2 Then ConsumablesValue.Clear()
        End If
    End Sub
