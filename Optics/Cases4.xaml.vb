...
Public Class Cases4
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.TestSecurity(Me, {btnSave}, {btnDelete}, {btnFirst, btnNext, btnPrevios, btnLast}, {btnPrint, btnPrint_Copy, btnApproval1, btnApproval2, btnApproval3, btnApproval4, btnApproval5})
        ...
        LoadWFH()
        If Md.MyProjectType = ProjectType.APSD OrElse Md.MyProjectType = ProjectType.APS OrElse Md.MyProjectType = ProjectType.ClinicDrSaberWaheeb Then
            lblId.Content = "MRN"
            lblJobId.Content = "وظيفة ولي لأمر"
            lblEnName.Visibility = Windows.Visibility.Hidden
            EnName.Visibility = Windows.Visibility.Hidden
        Else
            lblCityId.Visibility = Windows.Visibility.Hidden
            CityId.Visibility = Windows.Visibility.Hidden
            CityName.Visibility = Windows.Visibility.Hidden
        End If

        If Md.MyProjectType = ProjectType.APS Then
            lblCaseTypeId.Visibility = Windows.Visibility.Hidden
            ...
            lblMemberName.Visibility = Windows.Visibility.Hidden
            MemberName.Visibility = Windows.Visibility.Hidden
            lblRelationId.Visibility = Windows.Visibility.Hidden
            RelationId.Visibility = Windows.Visibility.Hidden
            RelationName.Visibility = Windows.Visibility.Hidden
            lblBrokerCoId.Visibility = Windows.Visibility.Hidden
            BrokerCoId.Visibility = Windows.Visibility.Hidden
            BrokerCoName.Visibility = Windows.Visibility.Hidden
            lblMembershipNo.Visibility = Windows.Visibility.Hidden
            MembershipNo.Visibility = Windows.Visibility.Hidden
        Else
            btnApproval1.Visibility = Windows.Visibility.Hidden
            btnApproval2.Visibility = Windows.Visibility.Hidden
            btnApproval3.Visibility = Windows.Visibility.Hidden
            btnApproval4.Visibility = Windows.Visibility.Hidden
            btnApproval5.Visibility = Windows.Visibility.Hidden

            G.Visible = False
            WFH.Visibility = Windows.Visibility.Hidden
        End If

        bm.Fields = New String() {SubId, "Name", "D", "M", "Y", "CityId", "Gender", "SSN", "Address", "DateOfBirth", "JobId", "Notes", "BankAccount", "NationalId", "HomePhone", "Mobile", "Password", "EnName", "mm", "Occupation", "MenstrualH", "ObstetricH", "FamilyH", "OvarianFactor", "UtrineFactor", "TubalAndPeritoneal", "ObstHx", "HusbandName", "HusbandAge", "HusbandOccupation", "Risk", "GynEx", "MaleFactor", "PreviousART", "Email", "Address2", "OOR", "M2", "Sperm", "MaleCount", "Moitlity", "G3", "AbnormalForm", "Fertilization", "Empbryos", "ClassA", "Cryo", "Pregnancy", "DateOnAdmission", "Weight", "OperatedBefore", "CaseTypeId", "DoctorId", "CompanyId", "AccNo", "SystemUser", "MemberName", "RelationId", "RelationId2", "ExitTypeId", "BrokerCoId", "MembershipNo", "UpdateDate", "EntryUser", "EntryDate", "Barcode", "RecordCivilian"}
        ...
        If Not Md.MyProjectType = ProjectType.ClinicWomen Then
        ...
        If Not Md.Manager Then
            ...
            btnPrintEditing.Visibility = Windows.Visibility.Hidden
        End If
    End Sub
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click, btnPrint.Click, btnApproval1.Click, btnApproval2.Click, btnApproval3.Click, btnApproval4.Click, btnApproval5.Click
        ...
        If txtName.Text.Trim = "" Or Not TestNames() Then
            ...
            Return
        End If
        If Md.MyProjectType = ProjectType.APS AndAlso DateOfBirth.SelectedDate Is Nothing Then
    ...
    Function TestNames() As Boolean
        If Md.MyProjectType = ProjectType.APSD OrElse Md.MyProjectType = ProjectType.APS Then Return True
    ...
    Private Sub RelationId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles RelationId.KeyUp
        bm.ShowHelp("Relations", RelationId, RelationName, e, "select cast(Id as varchar(100)) Id,Name from Relations", "Relations")
    End Sub

    Private Sub RelationId2_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles RelationId2.KeyUp
        bm.ShowHelp("Relations", RelationId2, RelationName2, e, "select cast(Id as varchar(100)) Id,Name from Relations", "Relations")
    End Sub

    Private Sub ExitTypeId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles ExitTypeId.KeyUp
        bm.ShowHelp("ExitTypes", ExitTypeId, ExitTypeName, e, "select cast(Id as varchar(100)) Id,Name from ExitTypes", "ExitTypes")
    End Sub

    Private Sub BrokerCoId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles BrokerCoId.KeyUp
    ...
    Private Sub CaseTypeId_SelectionChanged(sender As Object, e As SelectionChangedEventArgs) Handles CaseTypeId.SelectionChanged
        ...
        Select Case CaseTypeId.Items(CaseTypeId.SelectedIndex)(0)
            ...
            Case 4
                ...
                lblMemberName.Visibility = Windows.Visibility.Visible
                MemberName.Visibility = Windows.Visibility.Visible
                lblRelationId.Visibility = Windows.Visibility.Visible
                RelationId.Visibility = Windows.Visibility.Visible
                RelationName.Visibility = Windows.Visibility.Visible
                lblBrokerCoId.Visibility = Windows.Visibility.Visible
                BrokerCoId.Visibility = Windows.Visibility.Visible
                BrokerCoName.Visibility = Windows.Visibility.Visible
                lblMembershipNo.Visibility = Windows.Visibility.Visible
                MembershipNo.Visibility = Windows.Visibility.Visible
            Case 5
                lblDoctorId.Visibility = Windows.Visibility.Visible
                DoctorId.Visibility = Windows.Visibility.Visible
                DoctorName.Visibility = Windows.Visibility.Visible
