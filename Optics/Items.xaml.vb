...
Public Class Items
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not Md.MyProjectType = ProjectType.X11 Then
            IsKidneysWash.Visibility = Windows.Visibility.Hidden
        End If

        If Not (Md.MyProjectType = ProjectType.X11 OrElse Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X8) Then
        ...
        If Md.MyProjectType = ProjectType.X17 OrElse Md.MyProjectType = ProjectType.X3 Then
            ...
            ComboBoxItem2.Visibility = Windows.Visibility.Collapsed
            IsService.Visibility = Windows.Visibility.Collapsed
            'ImportPrice.Visibility = Windows.Visibility.Visible
            'lblImportPrice.Visibility = Windows.Visibility.Visible
        End If
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Md.MyProjectType = ProjectType.X17 AndAlso ItemUnitId.SelectedIndex < 1 Then
            bm.ShowMSG("برجاء تحديد الوحدة")
            ItemUnitId.Focus()
            Return
        End If

        If Md.MyProjectType = ProjectType.X17 AndAlso Val(CountryId.Text) = 0 Then
        ...
        Dim x As Integer = Val(bm.ExecuteScalar("select Id from " & TableName & " where Name='" & txtName.Text.Trim & "' and GroupId='" & GroupId.Text.Trim & "' and TypeId='" & TypeId.Text.Trim & "' and Id<>" & Val(txtID.Text)))
        If x > 0 Then
    ...
    Private Sub ItemType_SelectionChanged(ByVal sender As System.Object, ByVal e As System.Windows.Controls.SelectionChangedEventArgs) Handles ItemType.SelectionChanged
        ...
        If ItemType.SelectedIndex = 3 AndAlso Md.MyProjectType = ProjectType.X17 Then
    ...
    Private Sub ItemDiscountPerc_TextChanged(sender As Object, e As TextChangedEventArgs) Handles ItemDiscountPerc.TextChanged
        ItemDiscountValue.Text = bm.Rnd5LE(Val(SalesPrice.Text) * Val(ItemDiscountPerc.Text) / 100)
    End Sub
End Class
