...
Public Class ConferencesTypes
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, SubName, "IsActive", "CertificateLeft", "CertificateTop", "IDLeft", "IDTop"}
        bm.control = New Control() {txtID, txtName, CheckBox1, CertificateLeft, CertificateTop, IDLeft, IDTop}
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CertificateTop.KeyDown, CertificateLeft.KeyDown
    ...
    Private Sub BtnPrintAll_Copy_Click(sender As Object, e As RoutedEventArgs) Handles btnPrintAll_Copy.Click
        ...
        rpt.paravalue = New String() {0, "Client Name Will Appear Here"}
