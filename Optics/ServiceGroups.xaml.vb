...
Public Class ServiceGroups
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        Select Case Md.MyProjectType
            Case ProjectType.X2, ProjectType.X11
            Case Else
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If MainAccNo.Visibility = Windows.Visibility.Visible AndAlso Val(MainAccNo.Text) = 0 Then
            ...
            Return
        End If
        If SubAccNo.Visibility = Windows.Visibility.Visible AndAlso Val(SubAccNo.Text) = 0 AndAlso SubAccNo.IsEnabled Then
    ...
    Private Sub SubAccNo_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles SubAccNo.LostFocus
        If lop OrElse SubAccNo.Visibility = Windows.Visibility.Hidden Then Return
    ...
    Private Sub MainAccNo_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MainAccNo.LostFocus
        If MainAccNo.Visibility = Windows.Visibility.Hidden Then Return

        bm.AccNoLostFocus(MainAccNo, MainAccName)

        SubAccNo.IsEnabled = MainAccNo.Visibility <> Windows.Visibility.Visible OrElse bm.ExecuteAdapter("select * from LinkFile where Id=(select C.LinkFile from Chart C where C.Id='" & MainAccNo.Text & "')").Rows.Count > 0
        SubAccNo_LostFocus(Nothing, Nothing)
    End Sub
