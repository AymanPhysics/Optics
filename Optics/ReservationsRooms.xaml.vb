...
Public Class ReservationsRooms
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Md.MyProjectType = ProjectType.Zohor Then
            ...
            btnInpatientList.Visibility = Windows.Visibility.Hidden

            'OperationType.Visibility = Windows.Visibility.Hidden
            'lblOperationType.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub btnClick(ByVal sender As Object, ByVal e As RoutedEventArgs)
        ...
        bm.ShowHelp("", ToId, ToName, New System.Windows.Input.KeyEventArgs(Nothing, Nothing, Nothing, Key.F1), "select cast(r.Id as varchar(100)) Id,Name+' - '+c.Mobile+' - '+c.HomePhone Name from RoomsData r left join Cases c on(r.CaseId=c.Id) where r.RoomId='" & CType(sender, Button).Name.Split("_")(1) & "' and IsCurrent=1")
