...
Public Class Nolon
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CustomerId.KeyDown, DriverId.KeyDown, NolonPricesId.KeyDown
        bm.MyKeyPress(sender, e)
    End Sub

    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Value.KeyDown, Value2.KeyDown, Tips.KeyDown, Tips2.KeyDown, Payed.KeyDown, Payments.KeyDown, OtherPayments.KeyDown
    ...
    Private Sub NolonPricesId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles CustomerId.LostFocus, NolonPricesId.LostFocus, NolonPriceTypeId.LostFocus, NolonPriceTypeId.SelectionChanged
        ...
        End If
    End Sub
    Private Sub NolonPricesId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles NolonPricesId.KeyUp
