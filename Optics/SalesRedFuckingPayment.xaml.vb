...
Public Class SalesRedFuckingPayment
    ...
    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles CashValue.KeyDown, DiscountPerc.KeyDown, DiscountValue.KeyDown
