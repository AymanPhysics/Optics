...
Public Class Employees
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not Md.ShowSalaries Then
            ...
            BADGENUMBER.Visibility = Windows.Visibility.Hidden
        End If
        ...
        Select Case Md.MyProjectType
            ...
            Case ProjectType.X11

            Case ProjectType.X9
                TabItemChangedSalary.Visibility = Windows.Visibility.Collapsed
                TabItemDaysOff.Visibility = Windows.Visibility.Collapsed
                TabItemSalary.Visibility = Windows.Visibility.Collapsed
                TabItemShifts.Visibility = Windows.Visibility.Collapsed
                TabSpecialDyas.Visibility = Windows.Visibility.Collapsed
                TabItemJobDescribtion.IsSelected = True
            Case ProjectType.X8, ProjectType.X6, ProjectType.X10, ProjectType.X7 'ProjectType.ClinicWomen,
                ...
                If Not Md.MyProjectType = ProjectType.X8 Then
                    ...
                    btnStorePermissions.Visibility = Windows.Visibility.Hidden
                End If
            ...
            Case ProjectType.X13, ProjectType.X19, ProjectType.X22
                Doctor.Visibility = Windows.Visibility.Hidden
                'Nurse.Visibility = Windows.Visibility.Hidden
                Receptionist.Visibility = Windows.Visibility.Hidden
                lblTax.Visibility = Windows.Visibility.Hidden
            ...
            Case ProjectType.X4, ProjectType.X5, ProjectType.X29
                Doctor.Visibility = Windows.Visibility.Hidden
                'Nurse.Visibility = Windows.Visibility.Hidden
                Receptionist.Visibility = Windows.Visibility.Hidden
                lblTax.Visibility = Windows.Visibility.Hidden
            ...
            Case ProjectType.X14, ProjectType.X14
                Doctor.Visibility = Windows.Visibility.Hidden
                'Nurse.Visibility = Windows.Visibility.Hidden
                Receptionist.Content = "مدخل بيانات"

            Case ProjectType.X17, ProjectType.X15, ProjectType.Optics
                lblTax.Visibility = Windows.Visibility.Hidden
                lblTax2.Visibility = Windows.Visibility.Hidden
                Tax.Visibility = Windows.Visibility.Hidden
        ...
        Select Case Md.MyProjectType
            Case ProjectType.X2, ProjectType.X1, ProjectType.X8, ProjectType.X10, ProjectType.X6, ProjectType.X11, ProjectType.X9
                Nurse.Content = "تمريض"
            Case Else
    ...
    Private Sub Doctor_Checked(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Doctor.Checked
        ...
        If Md.MyProjectType = ProjectType.X8 Then
            For i As Integer = 0 To TabControl1.Items.Count - 1
                CType(TabControl1.Items(i), TabItem).Visibility = Windows.Visibility.Collapsed
            Next
            TabControl1.Visibility = Windows.Visibility.Visible
            TabItemJobDescribtion.Visibility = Windows.Visibility.Visible
