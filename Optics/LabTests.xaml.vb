...
Public Class LabTests
    ...
    Private Sub Sales_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Md.MyProjectType <> ProjectType.ClinicPublicElSadaka AndAlso Md.MyProjectType <> ProjectType.APS Then
            lblRInvoiceNo.Visibility = Windows.Visibility.Hidden
            RInvoiceNo.Visibility = Windows.Visibility.Hidden
            EmpId.Visibility = Windows.Visibility.Hidden
            lblReferredBy.Visibility = Windows.Visibility.Hidden
            ReferredBy.Visibility = Windows.Visibility.Hidden
        End If

        If Md.MyProjectType = ProjectType.ClinicWomen Then
            GUpdate.Visibility = Windows.Visibility.Hidden
            PanelResult.Visibility = Windows.Visibility.Hidden
        End If
    ...
    Sub FillControls()
        ...
        bm.FillControls(Me)
        CaseID_LostFocus(Nothing, Nothing)
        If Not Md.MyProjectType = ProjectType.ClinicWomen Then RInvoiceNo_LostFocus(Nothing, Nothing)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click, btnPrint.Click, btnPrint2.Click, btnPrint3.Click
        ...
        If ReferredBy.Visibility = Windows.Visibility.Visible AndAlso ReferredBy.Text.Trim = "" Then
        ...
        If CaseId.Text.Trim = "" Then
            ...
            Return
        End If
        If RInvoiceNo.Visibility = Windows.Visibility.Visible AndAlso Val(InvoiceNo.Text) = 0 And Val(RInvoiceNo.Text) = 0 And Not Md.Manager Then
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles CaseId.KeyDown, InvoiceNo.KeyDown, RInvoiceNo.KeyDown
