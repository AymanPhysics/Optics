...
Public Class InvestorsProfits
    ...
    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Val1.KeyDown, Val2.KeyDown
    ...
    Private Sub btncalc_Click(sender As Object, e As RoutedEventArgs) Handles btncalc.Click
        If G.Rows.Count = 0 OrElse bm.ShowDeleteMSG("سيتم مسح القيد وإعادة الاحتساب مرة أخري .. استمرار؟") Then
            ...
            dt = bm.ExecuteAdapter("LoadInvestorsBal0", {"Month", "Year", "Daydate"}, {DayDate2.SelectedDate.Value.Month, DayDate2.SelectedDate.Value.Year, bm.ToStrDate(DayDate.SelectedDate)})
            G.Rows.Clear()
            For i As Integer = 0 To dt.Rows.Count - 1
                G.Rows.Add()
                G.Rows(i).Cells(GC.Id).Value = dt.Rows(i)("Id").ToString
