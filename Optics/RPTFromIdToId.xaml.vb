...
Public Class RPTFromIdToId
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        If Flag = 1 Then
            ...
            For i As Integer = 0 To dt.Rows.Count - 1
                ...
                rpt.paravalue = New String() {Val(dt.Rows(i)(0)), dt.Rows(i)(1)}
    ...
    Private Sub ConferenceId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles ConferenceId.LostFocus
        ...
        dt = bm.ExecuteAdapter("select CertificateTop,CertificateLeft from conferences where Id=" & ConferenceId.Text)
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles FromId.KeyDown, ToId.KeyDown
