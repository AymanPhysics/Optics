        ...
        Try
            ...
            Dispatcher.BeginInvoke(Sub()
                                       If Not mydt Is Nothing Then
                                           ...
                                           Try
                                               DataGridView2.Columns(DataGridView2.Columns.Count - 2).Visibility = Windows.Visibility.Hidden
                                               DataGridView2.Columns(DataGridView2.Columns.Count - 1).Visibility = Windows.Visibility.Hidden
                                           Catch ex As Exception
                                           End Try

                                           Try

                                               DataGridView2.Columns(mydt.Columns("Id").Ordinal).Visibility = Windows.Visibility.Hidden
                                               DataGridView2.Columns(mydt.Columns("MyLine").Ordinal).Visibility = Windows.Visibility.Hidden
