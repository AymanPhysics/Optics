...
Public Class Conferences
    ...
    Private Sub InvoiceNo_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles InvoiceNo.KeyDown
        bm.MyKeyPress(sender, e)
    End Sub

    Private Sub InvoiceNo_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Value.KeyDown
    ...
    Private Sub ConferenceId_LostFocus(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles ConferenceId.LostFocus
        ...
        dt = bm.ExecuteAdapter("select CertificateTop,CertificateLeft,IDTop,IDLeft from conferences where Id=" & ConferenceId.Text)
    ...
    End Sub
    Private Sub ConferenceId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles ConferenceId.KeyUp
    ...
    Private Sub UniversityId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles UniversityId.KeyUp
    ...
    Private Sub SpecialtyId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles SpecialtyId.KeyUp
    ...
    Private Sub TitleId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles TitleId.KeyUp
    ...
    Private Sub SubSpecialtyId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles SubSpecialtyId.KeyUp
    ...
    Private Sub BtnPrintId_Click(sender As Object, e As RoutedEventArgs) Handles btnPrintId.Click
        ...
        If Payment.Text.Trim = "" AndAlso SponsorId.Text.Trim = "" Then
    ...
    Private Sub RegistrationTypeId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles RegistrationTypeId.KeyUp
    ...
    Private Sub AttendanceTypeId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles AttendanceTypeId.KeyUp
    ...
    Private Sub SponsorId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles SponsorId.KeyUp
    ...
    Private Sub HotelId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles HotelId.KeyUp
    ...
    Private Sub RoomTypeId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles RoomTypeId.KeyUp
    ...
    Private Sub RoomUpgradeTypeId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles RoomUpgradeTypeId.KeyUp
    ...
    Private Sub BtnPrintCertificate_Click(sender As Object, e As RoutedEventArgs) Handles btnPrintCertificate.Click
        ...
        rpt.paraname = New String() {"CustomerId", "CustomerName"}
        rpt.paravalue = New String() {Val(CustomerId.Text), CustomerName.Text}
        rpt.ReportViewer_Load(Nothing, Nothing)
        For Each c As ReportObject In rpt.ReportDoc.ReportDefinition.ReportObjects
            Try
