...
Public Class RPT12
    ...
    Public Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        Select Case Flag
            Case 1
                ...
                If Md.MyProjectType = ProjectType.X17 Then rpt.Rpt = "ItemCard_N.rpt"
            Case 2
                rpt.Rpt = "StoreBal.rpt"
                If Md.MyProjectType = ProjectType.X14 Then rpt.Rpt = "StoreBalSizes.rpt"
                If Md.MyProjectType = ProjectType.Optics Then rpt.Rpt = "StoreBal_O.rpt"
                If Md.MyProjectType = ProjectType.X8 Then rpt.Rpt = "StoreBal_Z.rpt"
            Case 3
                rpt.Rpt = "StoreBalAll.rpt"
            Case 4
                rpt.Rpt = "StoreBalLimit.rpt"
                If Md.MyProjectType = ProjectType.X8 Then rpt.Rpt = "StoreBalLimit_Z.rpt"
            Case 5, 51, 52
                rpt.Rpt = "StoreBalCost.rpt"
                If Md.MyProjectType = ProjectType.Optics Then rpt.Rpt = "StoreBalCost_O.rpt"
                If Md.MyProjectType = ProjectType.X8 Then rpt.Rpt = "StoreBalCost_Z.rpt"
            Case 6, 61, 62
            ...
            Case 10
                ...
                If Md.MyProjectType = ProjectType.X8 Then rpt.Rpt = "StoreExpiredItems_Z.rpt"
        End Select
        rpt.Show()
        'rpt.Show()
        'rpt.Close()
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Not ((Flag = 1 OrElse Flag = 9) AndAlso (Md.MyProjectType = ProjectType.X14)) Then
