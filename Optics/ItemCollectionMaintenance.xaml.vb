...
Br:
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles StoreId.KeyDown, InvoiceNo.KeyDown, txtID.KeyDown, ItemId.KeyDown, ToId.KeyDown
        bm.MyKeyPress(sender, e)
    End Sub

    Private Sub txtID_KeyPress2(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtPrice.KeyDown, Price.KeyDown
    ...
    Private Sub Done_Checked(sender As Object, e As RoutedEventArgs) Handles Done.Checked, Done.Unchecked
        If Done.IsChecked Then
            DayDate2.Visibility = Windows.Visibility.Visible
            If DayDate2.SelectedDate Is Nothing Then DayDate2.SelectedDate = bm.MyGetDate.Date
        Else
            DayDate2.Visibility = Windows.Visibility.Hidden
        End If
    End Sub
