...
Public Class Stores
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.Fields = New String() {SubId, SubName, "CostCenterId", "Flag", "AutomaticReceive", "CurrentDate", "CurrentShift", "StoreUnitId", "WhatsAppNotes"}
        bm.control = New Control() {txtID, txtName, CostCenterId, CheckBox1, CheckBox2, CurrentDate, CurrentShift, StoreUnitId, WhatsAppNotes}
        ...
        ElseIf Md.MyProjectType = ProjectType.X11 OrElse Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X2 OrElse Md.MyProjectType = ProjectType.X8 Then
