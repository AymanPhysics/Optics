...
Public Class DeliveryOrder_O
    ...
    Sub ClearControls()
        Try
            ...
            txtFlag.Text = Flag
            If Md.MyProjectType <> ProjectType.X11 AndAlso Md.MyProjectType <> ProjectType.X1 AndAlso Md.MyProjectType <> ProjectType.X2 Then CashierId.Text = Md.UserName
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles StoreId.KeyDown, InvoiceNo.KeyDown, ToId.KeyDown, CashierId.KeyDown, SaveId.KeyDown
    ...
    Private Sub DocNo_LostFocus(sender As Object, e As RoutedEventArgs) Handles DocNo.LostFocus
        Dim dt2 As DataTable = bm.ExecuteAdapter("GetSalesSerialDetails2", {"Flag", "StoreId", "DocNo", "SalesTypeIdState"}, {Flag, Val(StoreId.Text), Val(DocNo.Text), IIf(Md.MyProjectType = ProjectType.X17, 0, 1)})
        G.Rows.Clear()
