...
Public Class Groups
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Md.MyProjectType = ProjectType.X14 Then
            CheckBox1.Visibility = Windows.Visibility.Hidden
        ElseIf Md.MyProjectType = ProjectType.X11 OrElse Md.MyProjectType = ProjectType.X1 OrElse Md.MyProjectType = ProjectType.X2 Then
            CheckBox1.Content = "مستهلكات"
        End If

        If Not Md.MyProjectType = ProjectType.X8 AndAlso Not Md.MyProjectType = ProjectType.X6 AndAlso Not Md.MyProjectType = ProjectType.X9 AndAlso Not Md.MyProjectType = ProjectType.X10 AndAlso Not Md.MyProjectType = ProjectType.X11 AndAlso Not Md.MyProjectType = ProjectType.X1 AndAlso Not Md.MyProjectType = ProjectType.X2 Then bm.SetImage(Img, "attchmentfile.jpg")

        If Md.MyProjectType = ProjectType.X23 OrElse Md.MyProjectType = ProjectType.X8 Then
            lblTradingFirstAccNo.Visibility = Windows.Visibility.Hidden
            TradingFirstAccNo.Visibility = Windows.Visibility.Hidden
            TradingFirstAccName.Visibility = Windows.Visibility.Hidden

            lblTradingLastAccNo.Visibility = Windows.Visibility.Hidden
            TradingLastAccNo.Visibility = Windows.Visibility.Hidden
            TradingLastAccName.Visibility = Windows.Visibility.Hidden

            lblBudgetAccNo.Visibility = Windows.Visibility.Hidden
            BudgetAccNo.Visibility = Windows.Visibility.Hidden
            BudgetAccName.Visibility = Windows.Visibility.Hidden
        End If
    End Sub
