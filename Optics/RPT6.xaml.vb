...
Public Class RPT6
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        Select Case Detail
            ...
            Case 1
                rpt.Rpt = "Sales.rpt"
            Case 2
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X17, "DeletedSales_N.rpt", "DeletedSales.rpt")
            Case 3
                rpt.Rpt = "ItemsSales5.rpt"
            Case 4
                rpt.Rpt = IIf(Md.MyProjectType = ProjectType.X17, "SalesProfit_N.rpt", "SalesProfit.rpt")
            Case 5
            ...
            Case 7
                ...
                ElseIf Md.MyProjectType = ProjectType.X17 Then
            ...
            Case 21
                rpt.Rpt = "Sales4.rpt"
            Case 22
                rpt.Rpt = "Sales220.rpt"
            Case 23
                rpt.Rpt = "ItemsSales511.rpt"
        End Select
        rpt.Show()
    End Sub

    Dim MyLinkFile As Integer = 1
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        If Not (Md.MyProjectType = ProjectType.X8 AndAlso (Detail = 0 OrElse Detail = 1 OrElse Detail = 22)) Then
        ...
        bm.Addcontrol_MouseDoubleClick({CountryId, GroupId, TypeId, ItemId, StoreId, ToId, CashierId, WaiterId, AccNo})
        ...
        If (Flag = 3 OrElse Flag = 30 OrElse Flag = 9 OrElse Flag = 31 OrElse Flag = 28) AndAlso (Detail = 0 OrElse Detail = 1 OrElse Detail = 22) Then
            ...
            If Md.MyProjectType = ProjectType.X24 AndAlso (Flag = 3 OrElse Flag = 30) Then
        ...
        End If
        If Not (Flag = 10 And (Detail = 1 OrElse Detail = 22)) Then
