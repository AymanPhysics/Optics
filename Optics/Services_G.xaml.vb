...
Public Class Services_G
    ...
    Public Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        IsAutomatic.Visibility = Windows.Visibility.Hidden
        ...
        If Flag = 2 Then
            lbllblPayed.Visibility = Windows.Visibility.Hidden
        ...
        If IsEditing Then
            ...
            TabControl2.Visibility = Windows.Visibility.Hidden
            ...
            btnSaveWithoutPrint.Visibility = Windows.Visibility.Hidden
            'btnNew.Visibility = Windows.Visibility.Hidden
