...
Public Class Reservations
    ...
    Private Sub UserControl_Loaded(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles MyBase.Loaded
        ...
        InsertedDate.Visibility = Windows.Visibility.Hidden
        ...
        If Not Md.MyProjectType = ProjectType.APS Then
            ...
            lblPerc1.Visibility = Windows.Visibility.Hidden
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnSave.Click, btnSaveWithoutPrint.Click
        ...
        If Not MyProjectType = ProjectType.ClinicPublic AndAlso Not MyProjectType = ProjectType.ClinicDrSaberWaheeb AndAlso Not Canceled.IsChecked AndAlso Not Returned.IsChecked AndAlso sender Is btnSave Then ShowRPT()
