...
Public Class CaseInvoices
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.TestSecurity(Me, {btnSave}, {btnDelete}, {btnFirst, btnNext, btnPrevios, btnLast}, {btnPrint, btnPrint2, btnPrint3, btnPrintWithoutSave})
        ...
        btnGetAllCases.Visibility = Windows.Visibility.Hidden
        ...
        If Md.MyProjectType = ProjectType.Zohor Then
            TabItem5.Visibility = Windows.Visibility.Hidden
        End If
    End Sub
    ...
    Sub FillControls()
        ...
        btnPrintWithoutSave.Visibility = Windows.Visibility.Hidden
        bm.FillControls(Me)
        RemainingMainAccNo_LostFocus(Nothing, Nothing)
        bm.FillControls(Me)
    ...
    Sub ClearControls()
        btnPrintWithoutSave.Visibility = Windows.Visibility.Visible
        bm.ClearControls()
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, CaseId.KeyDown
