...
Public Class ConferencesCheckInOut
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        If Not Md.MyProjectType = ProjectType.PLEventsOffLine Then
        ...
        If Md.MyProjectType = ProjectType.PLEventsOffLine Then
    ...
    Private Sub Barcode_KeyUp(sender As Object, e As KeyEventArgs) Handles Barcode.KeyUp
        ...
        If e.Key = Key.Enter Then
            ...
            If Flag = 3 Then
                ...
                rpt.paravalue = New String() {Val(Barcode.Text), bm.ExecuteScalar("select Name from Customers where Id=" & Val(Barcode.Text))}
