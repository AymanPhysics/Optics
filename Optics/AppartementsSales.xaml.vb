...
Public Class AppartementsSales
    ...
    Private Sub txtID_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles txtID.KeyDown, Area.KeyDown
        bm.MyKeyPress(sender, e)
    End Sub

    Private Sub txtID2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles Price.KeyDown, Finishing.KeyDown, Transport.KeyDown, ElectricityAndWater.KeyDown, OtherCosts.KeyDown, Total.KeyDown, Payed.KeyDown, Payed2.KeyDown, Remaining.KeyDown
        bm.MyKeyPress(sender, e)
    End Sub
