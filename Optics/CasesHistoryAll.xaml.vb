...
Public Class CasesHistoryAll
    ...
    Private Sub BasicForm_Loaded(ByVal sender As Object, ByVal e As System.Windows.RoutedEventArgs) Handles Me.Loaded
        ...
        bm.TestSecurity(Me, {btnGet}, {btnDelete}, {btnFirst, btnNext, btnPrevios, btnLast}, {btnSave})
    ...
    Private Sub FillGrid()
        Try
            ...
            DG.Columns(dt.Columns("Payed").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("TypeId").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("SurgeonId").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("SurgeonId2").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("SurgeonId3").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("AnesthetistId").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("FromDate").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("ToDate").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("Line").Ordinal).Visibility = Windows.Visibility.Hidden
            ...
            DG.RowHeaderWidth = 0
            DG.MinColumnWidth = 0
            DG.Columns(dt.Columns("InvoiceNo").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("FromDate").Ordinal).Visibility = Windows.Visibility.Hidden
            DG.Columns(dt.Columns("ToDate").Ordinal).Visibility = Windows.Visibility.Hidden
