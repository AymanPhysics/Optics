...
Br:
    ...
    Private Sub OperationDescriptionId_LostFocus(sender As Object, e As RoutedEventArgs) Handles OperationDescriptionId.LostFocus
        If OperationDescriptionId.SelectedValue = 0 Then
            WFH0.Visibility = Windows.Visibility.Visible
            lblMotionType_Copy.Visibility = Windows.Visibility.Visible
            CalcBefore.Visibility = Windows.Visibility.Visible
            CalcAfter.Visibility = Windows.Visibility.Visible
        Else
            WFH0.Visibility = Windows.Visibility.Hidden
            lblMotionType_Copy.Visibility = Windows.Visibility.Hidden
            CalcBefore.Visibility = Windows.Visibility.Hidden
            CalcAfter.Visibility = Windows.Visibility.Hidden
        End If
    End Sub
    ...
    Private Sub CalcConsumablesValue_Checked(sender As Object, e As RoutedEventArgs) Handles CalcConsumablesValue.Checked, CalcConsumablesValue.Unchecked
        ...
        If CalcItems.IsChecked Then
            WFH.Visibility = Windows.Visibility.Visible
        Else
