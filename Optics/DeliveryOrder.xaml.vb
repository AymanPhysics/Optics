...
Public Class DeliveryOrder
    ...
    End Sub
    Private Sub DeliveryPersonId_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Input.KeyEventArgs) Handles DeliveryPersonId.KeyUp
    ...
    Private Sub DocNo_LostFocus(sender As Object, e As RoutedEventArgs) Handles DocNo.LostFocus
        ...
        Dim dt2 As DataTable = bm.ExecuteAdapter("GetSalesSerialDetails", {"Flag", "StoreId", "DocNo", "SalesTypeIdState"}, {Flag, Val(StoreId.Text), Val(DocNo.Text), IIf(Md.MyProjectType = ProjectType.X17, 0, 1)})
        G.Rows.Clear()
